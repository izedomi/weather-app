...
void main() async {
  ...
  late FavCityWeatherProvider favCityWeatherProvider;
  final apiRespnse = {
  ...
  setUp(() {
    ...
    favCityWeatherProvider = FavCityWeatherProvider(apiService: mockApiService);
  });
  ...
  test("successfully get weather with long and lat", () async {
    ...
    WeatherModel? weather =
        await favCityWeatherProvider.getCityWeather(long: long, lat: lat);
